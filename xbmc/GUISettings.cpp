...
//	AddCategory(4, "locale", 20026);
  ...
  AddInt(8, "audiooutput.boostmixdown", 13640, BOOST_DISABLED, BOOST_DISABLED, 1, BOOST_HUGE, SPIN_CONTROL_TEXT);
  AddBool(9, "audiooutput.normalisevolume", 577, false);
  AddBool(10, "audiooutput.systemoutputfollows", 578, true);
  AddBool(11, "audiooutput.systemvolumefollows", 579, true);
  
  // Controllers.
  AddCategory(4, "appleremote", 13600);
#ifdef __APPLE__
  AddInt(1, "appleremote.mode", 13601, APPLE_REMOTE_STANDARD, APPLE_REMOTE_DISABLED, 1, APPLE_REMOTE_MULTICODE, SPIN_CONTROL_TEXT);
...
//  AddCategory(5, "myvideos", 16000);
  ...
  AddInt(0, "videolibrary.flattentvshows", 20412, 0, 0, 1, 2, SPIN_CONTROL_TEXT);
  ...
  AddBool(11, "videolibrary.backgroundupdate", 22001, false);
  AddSeparator(12, "videolibrary.sep2");
  AddString(13, "videolibrary.cleanup", 334, "", BUTTON_CONTROL_STANDARD);
...
//  AddCategory(6, "remoteevents", 790);
  ...
  AddBool(8, "filelists.disableaddsourcebuttons", 21382, true);
